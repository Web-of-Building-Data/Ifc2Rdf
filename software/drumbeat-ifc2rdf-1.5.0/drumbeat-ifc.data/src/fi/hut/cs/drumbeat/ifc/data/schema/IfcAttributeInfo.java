...
public class IfcAttributeInfo implements Comparable<IfcAttributeInfo>, Serializable {
	...
	public boolean isSortedList() {
		return getAttributeTypeInfo() instanceof IfcListTypeInfo;
	}
	...
	/**
	 * @param isInverseFunctional the isInverseFunctional to set
	 */
...
//		return Ifc2RdfConverter.getDefaultConverter().convertAttributeToRdfUri(this);
//	}
//
//	@Override
