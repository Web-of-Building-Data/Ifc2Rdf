...
public class Test {
	...
	public void run() throws Exception {
		...
		//
		// export IFC meta-model
		//

		// export IFC meta-model into in-memory Jena graph using default conversion context
		Model metaModelGraph = outputMetaModelJenaModelFactory.createModel();
		Ifc2RdfExportUtil.exportMetaModelToJenaModel(metaModelGraph, model, conversionContextName);

		// export the in-memory Jena graph to file  
		RdfUtils.exportJenaModelToRdfFile(metaModelGraph, outputMetaModelFilePath, outputFileFormat, gzipOutputFile);		
	}
