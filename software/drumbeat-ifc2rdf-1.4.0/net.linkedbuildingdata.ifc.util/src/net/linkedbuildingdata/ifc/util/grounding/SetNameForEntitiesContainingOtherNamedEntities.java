...
import net.linkedbuildingdata.ifc.common.IfcHelper;
...
import net.linkedbuildingdata.ifc.data.model.IfcShortEntity;
...
import net.linkedbuildingdata.ifc.data.schema.IfcUniqueKeyInfo;
 ...
 *			<class>net.linkedbuildingdata.ifc.util.grounding.SetNameForEntitiesContainingOtherNamedEntities</class>
 *			<params>
