...
public class IfcVocabulary {
	...
	public class IfcCommandLineOptions {
		...
		public static final String INPUT_SCHEMA_FILE_DESCRIPTION = "Source IFC schema file";
		
		public static final String INPUT_MODEL_FILE_1_SHORT = "imf";
		public static final String INPUT_MODEL_FILE_LONG = "input-model-file";
		public static final String INPUT_MODEL_FILE_DESCRIPTION = "Source IFC model file";
		...
		public static final String OUTPUT_FILE_FORMAT_DESCRIPTION =
				"RDF format: TURTLE (default), NTRIPLES, NQUADS, RDFXML_ABBREV, RDFXML_PRETTY, etc. (see more: https://jena.apache.org/documentation/javadoc/arq/org/apache/jena/riot/RDFFormat.htm)";

		public static final String OUTPUT_MODEL_FILE_1_SHORT = "omf";
		public static final String OUTPUT_MODEL_FILE_LONG = "output-model-file";
		public static final String OUTPUT_MODEL_FILE_DESCRIPTION = "Target RDF file for the model";		
		...
		public static final String OUTPUT_MODEL_NAME_LONG = "output-model-name";
		public static final String OUTPUT_MODEL_NAME_DESCRIPTION = "Target RDF store for the model";		
