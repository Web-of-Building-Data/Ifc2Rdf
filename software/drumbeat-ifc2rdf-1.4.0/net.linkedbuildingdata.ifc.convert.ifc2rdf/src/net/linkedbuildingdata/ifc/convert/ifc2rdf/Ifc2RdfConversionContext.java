...
import net.linkedbuildingdata.rdf.*;
...
public class Ifc2RdfConversionContext extends OwlProfile {
	...
	public static Ifc2RdfConversionContext loadFromConfigurationFile() throws ConfigurationParserException {
		...
		ConfigurationItemEx configuration = configurationSection.getConfigurationPool().getDefault();
