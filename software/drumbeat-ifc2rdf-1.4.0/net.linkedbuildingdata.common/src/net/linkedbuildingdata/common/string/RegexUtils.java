package net.linkedbuildingdata.common.string;
...
public class RegexUtils {
	...
	public static String getHtmlSafeName(String name) {
		return RegexUtils.NON_WORD_CHARACTERS.matcher(name).replaceAll(StringUtils.EMPTY);
	}
