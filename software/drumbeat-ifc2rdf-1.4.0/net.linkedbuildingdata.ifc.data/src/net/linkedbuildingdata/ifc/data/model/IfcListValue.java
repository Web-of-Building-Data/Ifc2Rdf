...
import net.linkedbuildingdata.common.collections.IteratorComparer;
...
public abstract class IfcListValue<V extends IfcSingleValue> extends IfcValue { // implements IRdfList {
...
//	private List<IRdfLink> links;
	...
	public IfcListValue(List<V> values) {
		this();
...
//	}
	...
	public boolean equals(Object other) {
		if (other instanceof IfcListValue<?>) {
			return IteratorComparer.areEqual(this.getSingleValues(), ((IfcListValue<?>) other).getSingleValues());
		} else {
			return false;
		}
	}
